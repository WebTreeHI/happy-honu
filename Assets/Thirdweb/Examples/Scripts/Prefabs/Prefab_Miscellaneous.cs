...
public class Prefab_Miscellaneous : MonoBehaviour
{
    public async void GetBalance()
    {
        try
        {
            ...
            var contract = ThirdwebManager.Instance.SDK.GetContract("0x62Cf5485B6C24b707E47C5E0FB2EAe7EbE18EC4c");
            var balance = await contract.ERC1155.Balance("53564904441496180088395224062576891289430354265390015694998927954630043238401");
            Debugger.Instance.Log("[Get Balance] Token Balance", balance.ToString());
        }
